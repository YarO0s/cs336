...
from cs336_basics.model.data import loader
from cs336_basics.model.modules import func
from cs336_basics.model.modules import optimizers
...
def run_cross_entropy(
    ...
    """
    result = func.cross_entropy(inputs, targets)
    return result
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    func.grad_clipping(parameters, max_l2_norm)
...
def run_get_lr_cosine_schedule(
    ...
    """
    return func.lr_cosine_annealing(it, max_learning_rate, min_learning_rate, warmup_iters, cosine_cycle_iters)
...
def run_save_checkpoint(
    ...
    """
    func.save_checkpoint(model, optimizer, iteration, out)
...
def run_load_checkpoint(
    ...
    """
    return func.load_checkpoint(src, model, optimizer)
